...
(with-eval-after-load 'org
    ...
    (advice-add #'aiern-close-fold :before #'meq/go-to-parent)
...
(advice-add #'aiern-ex :around #'meq/evil-ex-advice)
...
(with-eval-after-load 'evil (defun meq/both-ex-define-cmd (cmd function) (interactive)
